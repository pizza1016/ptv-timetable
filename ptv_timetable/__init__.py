...
from .asyncapi import AsyncTimetableAPI
from .types import *
from . import _responsemodel

__all__ = ["TimetableAPI", "AsyncTimetableAPI", "METROPOLITAN_TRAIN", "METRO_TRAIN", "MET_TRAIN", "METRO", "TRAM", "BUS", "REGIONAL_TRAIN", "REG_TRAIN", "COACH", "VLINE", "EXPAND_ALL", "EXPAND_STOP", "EXPAND_ROUTE", "EXPAND_RUN", "EXPAND_DIRECTION", "EXPAND_DISRUPTION", "EXPAND_VEHICLE_DESCRIPTOR", "EXPAND_VEHICLE_POSITION", "EXPAND_NONE"]
...
class TimetableAPI(object):
    ...
    def get_pattern(self: Self,
                    ...
                    stop_id: IdentifierType | None = None,
    ...
    @overload
    def get_route(self: Self, route_id: IdentifierType, include_geopath: Literal[False] | None = None) -> Route:
        ...

    @overload
    def get_route(self: Self, route_id: IdentifierType, include_geopath: Literal[True], geopath_date: datetime | str | None = None) -> Route:
        ...

    def get_route(self: Self, route_id: IdentifierType, include_geopath: bool | None = None, geopath_date: datetime | str | None = None) -> Route:
        ...
        path = f"/v3/routes/{route_id}" + self.generate_url_params(include_geopath=include_geopath, geopath_utc=geopath_date.astimezone(timezone.utc).isoformat() if geopath_date is not None else None)
    ...
    def get_run(self: Self,
        ...
        path += self.generate_url_params(expand=expand, date_utc=date.astimezone(timezone.utc).isoformat() if date is not None else None, include_geopath=include_geopath)
    ...
    def list_stops(self: Self,
                   route_id: IdentifierType,
                   route_type: RouteTypeType,
                   direction_id: IdentifierType | None = None,
                   stop_disruptions: bool | None = None,
    ...
    def list_stops_near_location(self: Self,
                                 ...
                                 max_distance: DistanceType | None = None,
                                 stop_disruptions: bool | None = None
                                 ) -> list[Stop]:
    ...
    def list_departures(self: Self,
                        ...
                        direction_id: IdentifierType | None,
                        gtfs: Literal[True],
                        date: datetime | str | None = None,
                        max_results: int | None = None,
                        include_cancelled: bool | None = None,
    ...
    def list_departures(self: Self,
                        route_type: RouteTypeType,
                        stop_id: IdentifierType | str,
                        route_id: IdentifierType | None = None,
                        platform_numbers: Iterable[str | int] | str | int | None = None,
                        direction_id: IdentifierType | None = None,
                        gtfs: bool | None = None,
                        date: datetime | str | None = None,
    ...
    def get_disruption(self: Self, disruption_id: IdentifierType) -> Disruption:
    ...
    def get_fare_estimate(self: Self,
                          zone_a: FareZoneType,
                          zone_b: FareZoneType,
        ...
        return FareEstimate.load(**res) if res is not None else None
    ...
    def list_outlets(self: Self,
                     latitude: LatitudeType | None = None,
                     longitude: LongitudeType | None = None,
                     max_distance: DistanceType | None = None,
                     max_results: int | None = None
                     ) -> list[Outlet]:
