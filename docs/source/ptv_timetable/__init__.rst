``ptv_timetable`` — Wrapper for the PTV Timetable API
=====================================================

.. py:currentmodule:: ptv_timetable
...
.. autosummary::
    ...
    TimetableAPI
    TimetableAPI.generate_url_params
    TimetableAPI.get_direction
    TimetableAPI.get_disruption
    TimetableAPI.get_fare_estimate
    TimetableAPI.get_pattern
    TimetableAPI.get_route
    TimetableAPI.get_run
    TimetableAPI.get_stop
    TimetableAPI.list_departures
    TimetableAPI.list_disruption_modes
    TimetableAPI.list_disruptions
    TimetableAPI.list_outlets
    TimetableAPI.list_route_directions
    TimetableAPI.list_route_types
    TimetableAPI.list_routes
    TimetableAPI.list_runs
    TimetableAPI.list_stops
    TimetableAPI.list_stops_near_location
    TimetableAPI.request
    TimetableAPI.search
...
-----------------
    ...
    .. py:class:: TimetableAPI[**_P, _R](dev_id, key, *, calls=1, period=10, ratelimit_handler=ratelimit.decorators.sleep_and_retry, session=None)
